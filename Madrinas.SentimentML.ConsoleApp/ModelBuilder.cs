...
namespace Madrinas_SentimentML.ConsoleApp
{
    public static class ModelBuilder
    {
        private static string TRAIN_DATA_FILEPATH = @"C:\dev\TwitterSentiment\TrainML\yelp_labelled.txt";
        private static string MODEL_FILEPATH = @"../../../../Madrinas_SentimentML.Model/MLModel.zip";
